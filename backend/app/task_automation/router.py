...
async def create_task(
    ...
    task = await service.create_task(
        ...
        dreaming_days=body.dreaming_days,
        dreaming_min_actions=body.dreaming_min_actions,
        dreaming_persona=body.dreaming_persona,
    ...
    return TaskResponse(
        ...
        dreaming_days=task.dreaming_days,
        dreaming_min_actions=task.dreaming_min_actions,
        dreaming_persona=task.dreaming_persona,
    ...
    return PaginatedTasks(
        items=[
            TaskListItem(
                ...
                dreaming_days=t.dreaming_days,
                dreaming_min_actions=t.dreaming_min_actions,
                dreaming_persona=t.dreaming_persona,
